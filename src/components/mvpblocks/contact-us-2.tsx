...
export default function ContactUs({ className }: { className?: string }) {
  ...
  return (
    <section className={`${className} w-full max-w-screen-md px-2`}>
      <h2 className="mt-4 mb-5 primary-gradient bg-clip-text text-center text-4xl font-bold text-transparent md:text-6xl">
        Let&apos;s Get in Touch
      </h2>
        ...
        <div>
          ...
          <div className="mb-12 flex gap-8">
            ...
            <div className="text-md text-slate-300">
              <p>Email to us at </p>
              <p>info@codiate_solutions.com</p>
            </div>
          </div>
          ...
          <div className="flex space-x-12 py-7">
            <Link
              ...
              href="https://facebook.com/codiate_solutions"
            >
            ...
            <Link
              ...
              href="https://instagram.com/codiate_solutions"
            >
