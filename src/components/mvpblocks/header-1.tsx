        ...
        <div className="flex h-16 items-center justify-between lg:h-20">
          ...
          >
            <Link
              ...
              className="flex items-center space-x-2"
            >
              <div className="items-center justify-center rounded-lg hidden max-sm:flex">
                <Image
                  src="/images/codiate-favicon.svg"
              ...
              <span className="hidden md:inline-block bg-clip-text text-2xl font-bold text-transparent">
                <span className="text-blue-700">Codiate</span>{" "}
          ...
          <div className="hidden items-center space-x-4 lg:flex">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                prefetch={false}
                href="/signup"
                className="inline-flex items-center space-x-2 rounded-full primary-gradient px-6 py-2.5 font-medium text-white transition-all duration-200 hover:shadow-lg"
              >
              ...
              <div className="border-border bg-background/95 mt-4 space-y-2 rounded-xl border py-4 shadow-xl backdrop-blur-lg">
                ...
                <div className="px-4 py-2">
                  <Link
                    prefetch={false}
                    href="/signup"
                    className="block w-full rounded-lg primary-gradient py-2.5 text-center font-medium text-white transition-all duration-200 hover:shadow-lg"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    Book a Call
                  </Link>
